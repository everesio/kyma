...
type Config struct {
	...
	SecretsNamespace			 string        `envconfig:"default=kyma-integration"`
...
func (o *Config) String() string {
	return fmt.Sprintf("AgentConfigurationSecret=%s, "+
		...
		"DirectorProxyPort=%v,  DirectorProxyInsecureSkipVerify=%v, HealthPort=%s, SecretsNamespace=%s",
		...
		o.DirectorProxy.Port, o.DirectorProxy.InsecureSkipVerify, o.HealthPort, o.SecretsNamespace)
}
